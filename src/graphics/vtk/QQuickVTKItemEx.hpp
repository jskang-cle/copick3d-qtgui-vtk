...
class QQuickVTKItemEx : public QQuickItem
{
  Q_OBJECT

public:
  explicit QQuickVTKItemEx(QQuickItem* parent = nullptr);
  ~QQuickVTKItemEx() override;
...
private: // NOLINT(readability-redundant-access-specifiers)
  Q_DISABLE_COPY(QQuickVTKItemEx)
  Q_DECLARE_PRIVATE_D(_d_ptr, QQuickVTKItemEx)
  QScopedPointer<QQuickVTKItemExPrivate> _d_ptr;
};
