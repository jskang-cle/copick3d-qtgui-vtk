...
/**
 * @class   vtkCameraOrientationWidgetEx
 * @brief   A widget to manipulate vtkCameraOrientationWidgetEx.
 *
 *
 * This 3D widget creates and manages its own vtkCameraOrientationRepresentationEx.
 ...
 * into the vtkCameraOrientationWidgetEx's widget events:
 * <pre>
 ...
 *
 * @par Event Bindings:
 * This class, and the affiliated vtkCameraOrientationRepresentationEx,
 * are second generation VTK widgets.
 *
 * @sa
 * vtkCameraOrientationRepresentationEx
 */

#ifndef vtkCameraOrientationWidgetEx_h
#define vtkCameraOrientationWidgetEx_h
...
class vtkCameraOrientationRepresentationEx;
class vtkRenderer;

class vtkCameraOrientationWidgetEx : public vtkAbstractWidget
{
public:
  static vtkCameraOrientationWidgetEx* New();
  vtkTypeMacro(vtkCameraOrientationWidgetEx, vtkAbstractWidget);
   ...
   */
  void SetRepresentation(vtkCameraOrientationRepresentationEx* r);

  /**
   * Create a vtkCameraOrientationRepresentationEx.
   */
...
protected:
  vtkCameraOrientationWidgetEx();
  ~vtkCameraOrientationWidgetEx() override;
...
private:
  vtkCameraOrientationWidgetEx(const vtkCameraOrientationWidgetEx&) = delete;
  void operator=(const vtkCameraOrientationWidgetEx&) = delete;
};
