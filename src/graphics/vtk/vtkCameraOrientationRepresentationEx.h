...
class vtkCameraOrientationRepresentationEx : public vtkWidgetRepresentation
{
public:
  static vtkCameraOrientationRepresentationEx* New();
  vtkTypeMacro(vtkCameraOrientationRepresentationEx, vtkWidgetRepresentation);
...
protected:
  ...
  ~vtkCameraOrientationRepresentationEx() override;
...
private:
  vtkCameraOrientationRepresentationEx(const vtkCameraOrientationRepresentationEx&) = delete;
  void operator=(const vtkCameraOrientationRepresentationEx&) = delete;
};
