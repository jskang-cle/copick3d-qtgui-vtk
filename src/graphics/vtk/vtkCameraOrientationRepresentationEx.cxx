...
#define GETLABELPROPERTY(DIM, DIR)                                                                 \
  vtkTextProperty* vtkCameraOrientationRepresentationEx::Get##DIM##DIR##LabelProperty()              \
  {                                                                                                \
...
vtkStandardNewMacro(vtkCameraOrientationRepresentationEx);
...
//-----------------------------------------------------------------------------
vtkCameraOrientationRepresentationEx::vtkCameraOrientationRepresentationEx()
{
...
//-----------------------------------------------------------------------------
vtkCameraOrientationRepresentationEx::~vtkCameraOrientationRepresentationEx() = default;

//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::PositionHandles()
{
  // transform skeleton.
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::CreateDefaultGeometry()
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::CreateDefaultProperties()
{
  // 1. Fill color arrays.
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::ShallowCopy(vtkProp* prop)
{
  vtkCameraOrientationRepresentationEx* a = vtkCameraOrientationRepresentationEx::SafeDownCast(prop);
  if (a != nullptr)
  {
    for (int ax = 0; ax < 3; ++ax)
    {
...
//------------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::ApplyInteractionState(const InteractionStateType& state)
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::ApplyInteractionState(const int& state)
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::GetActors(vtkPropCollection* ac)
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::BuildRepresentation()
{
...
//-----------------------------------------------------------------------------
int vtkCameraOrientationRepresentationEx::ComputeInteractionState(int X, int Y, int modify /* = 0*/)
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::StartWidgetInteraction(double eventPos[2])
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::WidgetInteraction(double newEventPos[2])
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::EndWidgetInteraction(double newEventPos[2])
{
  if (this->GetInteractionStateAsEnum() == InteractionStateType::Rotating)
  {
    this->PickedAxis = -1;
...
void vtkCameraOrientationRepresentationEx::Rotate(double newEventPos[2])
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::FinalizeHandlePicks()
{
  if (this->InteractionState ==
    to_underlying(vtkCameraOrientationRepresentationEx::InteractionStateType::Hovering))
  {
...
//-----------------------------------------------------------------------------
double* vtkCameraOrientationRepresentationEx::GetBounds()
{
  vtkBoundingBox bbox;
...
//-----------------------------------------------------------------------------
vtkTransform* vtkCameraOrientationRepresentationEx::GetTransform()
{
  return this->Transform;
}

//-----------------------------------------------------------------------------
int vtkCameraOrientationRepresentationEx::RenderOpaqueGeometry(vtkViewport* vp)
{
...
//-----------------------------------------------------------------------------
int vtkCameraOrientationRepresentationEx::RenderTranslucentPolygonalGeometry(vtkViewport* vp)
{
  int count = 0;
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCameraOrientationRepresentationEx::HasTranslucentPolygonalGeometry()
{
  this->Container->GetMapper()->Update();
  int count = 0;
  if (this->Container->GetVisibility())
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::ReleaseGraphicsResources(vtkWindow* win)
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::SetContainerVisibility(bool state)
{
...
//-----------------------------------------------------------------------------
bool vtkCameraOrientationRepresentationEx::GetContainerVisibility()
{
  return this->Container->GetVisibility();
}

//-----------------------------------------------------------------------------
vtkProperty* vtkCameraOrientationRepresentationEx::GetContainerProperty()
{
  return this->Container->GetProperty();
}

//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::HighlightHandle()
{
  int dpi = 100;
  if (this->Renderer == nullptr)
  {
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::RegisterPickers()
{
...
//-----------------------------------------------------------------------------
void vtkCameraOrientationRepresentationEx::PrintSelf(ostream& os, vtkIndent indent)
{
